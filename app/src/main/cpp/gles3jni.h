...
extern "C" {
JNIEXPORT void JNICALL Java_com_example_glesnative_GLNativeJNI_init(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL Java_com_example_glesnative_GLNativeJNI_resize(JNIEnv *env, jclass type, jint width, jint height);
JNIEXPORT void JNICALL Java_com_example_glesnative_GLNativeJNI_step(JNIEnv *env, jclass type);
};
#endif // GLES3JNI_H
